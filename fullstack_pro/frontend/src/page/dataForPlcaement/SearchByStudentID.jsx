...
const SearchByStudentID = () => {
  ...
  const handleSearch = async () => {
    ...
    setStudent(null);
    try {
      const response = await axios.post("/api/track/job/one-student-track", { studentCode });
                ...
                <tr key={result.jobTrackerID}>
                  ...
                  <td>
                    {result.studentInRounds.resumeRoundCompleted
                      ? result.studentInRounds.resumeSelect ? "True" : "False"
                      : "--"
                    }
                  </td>
                  <td>{result.studentInRounds.firstRoundCompleted 
                        ? result.studentInRounds.firstRound ? "True" : "False"
                        : "--"
                      }
                    </td>
                  <td>{result.studentInRounds.secondRoundCompleted 
                        ? result.studentInRounds.secondRound ? "True" : "False"
                        : "--"
                      }
                  </td>
                  <td>{result.studentInRounds.thirdRoundCompleted 
                        ? result.studentInRounds.thirdRound ? "True" : "False"
                        : "--"
                    }
                  </td>
                  <td>{result.studentInRounds.fourthRoundCompleted 
                        ? result.studentInRounds.fourthRound ? "True" : "False"
                        : "--"
                    }
                 </td>
                  <td>{result.studentInRounds.finalRoundCompleted 
                     ? result.studentInRounds.finalRound ? "True" : "False"
                     :"--"                  
                    }
                  </td>
                </tr>
